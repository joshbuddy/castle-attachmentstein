...
/*
Attachmentstein.Main.prototype._mvPushMatrix = function() {
    var copy = mat4.create();
    mat4.set(this.mvMatrix, copy);
    this._mvMatrixStack.push(copy);
};

Attachmentstein.Main.prototype._mvPopMatrix = function() {
...
Attachmenstein.Main.prototype._drawScene = function() {
	...
	this.objectPipeline.forEach(function(object) {
		...
		// object transform
		mat4.translate(this.mvMatrix, [object.z, object.y, object.x]);
